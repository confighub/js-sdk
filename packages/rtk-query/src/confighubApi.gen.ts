...
const injectedRtkApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      bulkDeleteSpaces: build.mutation<
        BulkDeleteSpacesApiResponse,
        BulkDeleteSpacesApiArg
      >({
        query: (queryArg) => ({
          url: `/_space`,
          method: "DELETE",
      ...
      bulkPatchSpaces: build.mutation<
        BulkPatchSpacesApiResponse,
        BulkPatchSpacesApiArg
      >({
        query: (queryArg) => ({
          url: `/_space`,
          method: "PATCH",
      ...
      bulkCreateSpaces: build.mutation<
        BulkCreateSpacesApiResponse,
        BulkCreateSpacesApiArg
      >({
        query: (queryArg) => ({
          url: `/_space`,
          method: "POST",
      ...
      listAllAttributes: build.query<
        ListAllAttributesApiResponse,
        ListAllAttributesApiArg
      >({
        query: (queryArg) => ({
          url: `/attribute`,
          params: {
      ...
      getQueuedOperation: build.query<
        GetQueuedOperationApiResponse,
        GetQueuedOperationApiArg
      >({
        query: (queryArg) => ({
      ...
      listAllChangeSets: build.query<
        ListAllChangeSetsApiResponse,
        ListAllChangeSetsApiArg
      >({
        query: (queryArg) => ({
          url: `/change_set`,
          params: {
      ...
      listAllFilters: build.query<
        ListAllFiltersApiResponse,
        ListAllFiltersApiArg
      >({
        query: (queryArg) => ({
          url: `/filter`,
          params: {
      ...
      bulkPatchFilters: build.mutation<
        BulkPatchFiltersApiResponse,
        BulkPatchFiltersApiArg
      >({
        query: (queryArg) => ({
          url: `/filter`,
          method: "PATCH",
      ...
      bulkCreateFilters: build.mutation<
        BulkCreateFiltersApiResponse,
        BulkCreateFiltersApiArg
      >({
        query: (queryArg) => ({
          url: `/filter`,
          method: "POST",
      ...
      listOrgFunctions: build.query<
        ListOrgFunctionsApiResponse,
        ListOrgFunctionsApiArg
      >({
        query: (queryArg) => ({
          url: `/function`,
          params: {
      ...
      listAllInvocations: build.query<
        ListAllInvocationsApiResponse,
        ListAllInvocationsApiArg
      >({
        query: (queryArg) => ({
          url: `/invocation`,
          params: {
      ...
      bulkDeleteLinks: build.mutation<
        BulkDeleteLinksApiResponse,
        BulkDeleteLinksApiArg
      >({
        query: (queryArg) => ({
          url: `/link`,
          method: "DELETE",
      ...
      searchListLinks: build.query<
        SearchListLinksApiResponse,
        SearchListLinksApiArg
      >({
        query: (queryArg) => ({
          url: `/link`,
          params: {
      ...
      bulkPatchLinks: build.mutation<
        BulkPatchLinksApiResponse,
        BulkPatchLinksApiArg
      >({
        query: (queryArg) => ({
          url: `/link`,
          method: "PATCH",
      ...
      bulkCreateLinks: build.mutation<
        BulkCreateLinksApiResponse,
        BulkCreateLinksApiArg
      >({
        query: (queryArg) => ({
          url: `/link`,
          method: "POST",
      ...
      deleteOAuthClient: build.mutation<
        DeleteOAuthClientApiResponse,
        DeleteOAuthClientApiArg
      >({
        query: (queryArg) => ({
      ...
      getOAuthClient: build.query<
        GetOAuthClientApiResponse,
        GetOAuthClientApiArg
      >({
      ...
      listAllReleases: build.query<
        ListAllReleasesApiResponse,
      ...
      deleteAttribute: build.mutation<
        DeleteAttributeApiResponse,
        DeleteAttributeApiArg
      >({
        query: (queryArg) => ({
      ...
      patchAttribute: build.mutation<
        PatchAttributeApiResponse,
        PatchAttributeApiArg
      >({
        query: (queryArg) => ({
          url: `/space/${queryArg.spaceId}/attribute/${queryArg.attributeId}`,
          method: "PATCH",
      ...
      listBridgeWorkers: build.query<
        ListBridgeWorkersApiResponse,
        ListBridgeWorkersApiArg
      >({
        query: (queryArg) => ({
      ...
      getBridgeWorker: build.query<
        GetBridgeWorkerApiResponse,
        GetBridgeWorkerApiArg
      >({
        query: (queryArg) => ({
          url: `/space/${queryArg.spaceId}/bridge_worker/${queryArg.bridgeWorkerId}`,
          params: {
      ...
      patchBridgeWorker: build.mutation<
        PatchBridgeWorkerApiResponse,
        PatchBridgeWorkerApiArg
      >({
        query: (queryArg) => ({
          url: `/space/${queryArg.spaceId}/bridge_worker/${queryArg.bridgeWorkerId}`,
          method: "PATCH",
      ...
      createChangeSet: build.mutation<
        CreateChangeSetApiResponse,
        CreateChangeSetApiArg
      >({
        query: (queryArg) => ({
          url: `/space/${queryArg.spaceId}/change_set`,
          method: "POST",
      ...
      deleteChangeSet: build.mutation<
        DeleteChangeSetApiResponse,
        DeleteChangeSetApiArg
      >({
        query: (queryArg) => ({
      ...
      patchChangeSet: build.mutation<
        PatchChangeSetApiResponse,
        PatchChangeSetApiArg
      >({
        query: (queryArg) => ({
          url: `/space/${queryArg.spaceId}/change_set/${queryArg.changeSetId}`,
          method: "PATCH",
      ...
      updateChangeSet: build.mutation<
        UpdateChangeSetApiResponse,
        UpdateChangeSetApiArg
      >({
        query: (queryArg) => ({
          url: `/space/${queryArg.spaceId}/change_set/${queryArg.changeSetId}`,
          method: "PUT",
      ...
      invokeFunctions: build.mutation<
        InvokeFunctionsApiResponse,
      ...
      listInvocations: build.query<
        ListInvocationsApiResponse,
        ListInvocationsApiArg
      >({
        query: (queryArg) => ({
      ...
      createInvocation: build.mutation<
        CreateInvocationApiResponse,
        CreateInvocationApiArg
      >({
        query: (queryArg) => ({
          url: `/space/${queryArg.spaceId}/invocation`,
          method: "POST",
      ...
      deleteInvocation: build.mutation<
        DeleteInvocationApiResponse,
        DeleteInvocationApiArg
      >({
        query: (queryArg) => ({
      ...
      patchInvocation: build.mutation<
        PatchInvocationApiResponse,
        PatchInvocationApiArg
      >({
        query: (queryArg) => ({
          url: `/space/${queryArg.spaceId}/invocation/${queryArg.invocationId}`,
          method: "PATCH",
      ...
      updateInvocation: build.mutation<
        UpdateInvocationApiResponse,
        UpdateInvocationApiArg
      >({
        query: (queryArg) => ({
          url: `/space/${queryArg.spaceId}/invocation/${queryArg.invocationId}`,
          method: "PUT",
      ...
      publishRelease: build.mutation<
        PublishReleaseApiResponse,
        PublishReleaseApiArg
      >({
        query: (queryArg) => ({
          url: `/space/${queryArg.spaceId}/release`,
          method: "POST",
      ...
      getUnitExtended: build.query<
        GetUnitExtendedApiResponse,
        GetUnitExtendedApiArg
      >({
        query: (queryArg) => ({
      ...
      listUnitActions: build.query<
        ListUnitActionsApiResponse,
        ListUnitActionsApiArg
      >({
        query: (queryArg) => ({
      ...
      listUnitEvents: build.query<
        ListUnitEventsApiResponse,
        ListUnitEventsApiArg
      >({
        query: (queryArg) => ({
      ...
      bulkDeleteTags: build.mutation<
        BulkDeleteTagsApiResponse,
        BulkDeleteTagsApiArg
      >({
        query: (queryArg) => ({
          url: `/tag`,
          method: "DELETE",
      ...
      bulkPatchTags: build.mutation<
        BulkPatchTagsApiResponse,
        BulkPatchTagsApiArg
      >({
        query: (queryArg) => ({
          url: `/tag`,
      ...
      bulkCreateTags: build.mutation<
        BulkCreateTagsApiResponse,
        BulkCreateTagsApiArg
      >({
        query: (queryArg) => ({
          url: `/tag`,
          method: "POST",
      ...
      bulkDeleteTargets: build.mutation<
        BulkDeleteTargetsApiResponse,
        BulkDeleteTargetsApiArg
      >({
        query: (queryArg) => ({
          url: `/target`,
          method: "DELETE",
      ...
      listAllTargets: build.query<
        ListAllTargetsApiResponse,
        ListAllTargetsApiArg
      >({
        query: (queryArg) => ({
          url: `/target`,
          params: {
      ...
      bulkPatchTargets: build.mutation<
        BulkPatchTargetsApiResponse,
        BulkPatchTargetsApiArg
      >({
        query: (queryArg) => ({
          url: `/target`,
          method: "PATCH",
      ...
      listAllTriggers: build.query<
        ListAllTriggersApiResponse,
        ListAllTriggersApiArg
      >({
        query: (queryArg) => ({
          url: `/trigger`,
          params: {
      ...
      bulkPatchTriggers: build.mutation<
        BulkPatchTriggersApiResponse,
        BulkPatchTriggersApiArg
      >({
        query: (queryArg) => ({
          url: `/trigger`,
          method: "PATCH",
      ...
      bulkDeleteUnits: build.mutation<
        BulkDeleteUnitsApiResponse,
        BulkDeleteUnitsApiArg
      >({
        query: (queryArg) => ({
          url: `/unit`,
          method: "DELETE",
      ...
      bulkPatchUnits: build.mutation<
        BulkPatchUnitsApiResponse,
      ...
      bulkCreateUnits: build.mutation<
        BulkCreateUnitsApiResponse,
        BulkCreateUnitsApiArg
      >({
        query: (queryArg) => ({
          url: `/unit`,
          method: "POST",
      ...
      listAllUnitActions: build.query<
        ListAllUnitActionsApiResponse,
        ListAllUnitActionsApiArg
      >({
        query: (queryArg) => ({
          url: `/unit_action`,
          params: {
      ...
      bulkPatchViews: build.mutation<
        BulkPatchViewsApiResponse,
        BulkPatchViewsApiArg
      >({
        query: (queryArg) => ({
          url: `/view`,
          method: "PATCH",
      ...
      bulkCreateViews: build.mutation<
        BulkCreateViewsApiResponse,
        BulkCreateViewsApiArg
      >({
        query: (queryArg) => ({
          url: `/view`,
          method: "POST",
...
export type BulkDeleteSpacesApiResponse =
...
export type BulkCreateAttributesApiResponse =
  | /** status 200 OK */ AttributeCreateOrUpdateResponseRead[]
...
export type BulkDeleteBridgeWorkersApiResponse =
  | /** status 200 OK */ DeleteResponse[]
  | /** status 207 Multi-Status: Mixed success and failure results */ DeleteResponse[];
...
export type BulkPatchBridgeWorkersApiResponse =
  | /** status 200 OK */ BridgeWorkerCreateOrUpdateResponseRead[]
...
export type BulkCreateChangeSetsApiResponse =
  | /** status 200 OK */ ChangeSetCreateOrUpdateResponseRead[]
...
export type BulkPatchFiltersApiResponse =
  | /** status 200 OK */ FilterCreateOrUpdateResponseRead[]
...
export type BulkCreateFiltersApiResponse =
  | /** status 200 OK */ FilterCreateOrUpdateResponseRead[]
...
export type InvokeFunctionsOnOrgApiResponse =
  | /** status 200 OK */ FunctionInvocationsResponse[]
...
export type BulkDeleteInvocationsApiResponse =
  | /** status 200 OK */ DeleteResponse[]
  | /** status 207 Multi-Status: Mixed success and failure results */ DeleteResponse[];
...
export type BulkCreateLinksApiResponse =
  | /** status 200 OK */ LinkCreateOrUpdateResponseRead[]
...
export type ListAllReleasesApiResponse =
...
export type ListAttributesApiResponse =
  /** status 200 OK */ ExtendedAttributeRead[];
...
export type GetAttributeApiResponse =
  /** status 200 OK */ ExtendedAttributeRead;
...
export type ListBridgeWorkerStatusesApiResponse =
  /** status 200 OK */ BridgeWorkerStatus[];
...
export type InvokeFunctionsApiResponse =
  | /** status 200 OK */ FunctionInvocationsResponse[]
  | /** status 207 Multi-Status: Mixed success and failure results */ FunctionInvocationsResponse[];
...
export type ListInvocationsApiResponse =
  /** status 200 OK */ ExtendedInvocationRead[];
...
export type GetInvocationApiResponse =
  /** status 200 OK */ ExtendedInvocationRead;
...
export type PatchViewApiResponse =
  /** status 200 Defines an entity view. */ ViewRead;
...
export type UpdateViewApiResponse =
  /** status 200 Defines an entity view. */ ViewRead;
...
export type BulkCreateTagsApiResponse =
  | /** status 200 OK */ TagCreateOrUpdateResponseRead[]
...
export type BulkDeleteTargetsApiResponse =
  | /** status 200 OK */ DeleteResponse[]
  | /** status 207 Multi-Status: Mixed success and failure results */ DeleteResponse[];
...
export type BulkDeleteTriggersApiResponse =
  | /** status 200 OK */ DeleteResponse[]
  | /** status 207 Multi-Status: Mixed success and failure results */ DeleteResponse[];
...
export type BulkCreateTriggersApiResponse =
  | /** status 200 OK */ TriggerCreateOrUpdateResponseRead[]
...
export type BulkPatchUnitsApiResponse =
  | /** status 200 OK */ UnitCreateOrUpdateResponseRead[]
...
export type BulkCreateUnitsApiResponse =
  | /** status 200 OK */ UnitCreateOrUpdateResponseRead[]
...
export type BulkCreateViewsApiResponse =
  | /** status 200 OK */ ViewCreateOrUpdateResponseRead[]
